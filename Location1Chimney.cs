  ...
  public override void clickAction()
  {
    if (this.usedItem == string.Empty)
    {
      ...
      if (GameDataController.gd.getObjective("chimney_charcoal") || GameDataController.gd.getObjectiveDetail("chimney_wood") > 0)
        flag2 = true;
      string str2 = flag1 || flag2 ? str1 + " " + GameStrings.getString(GameStrings.actions, "base_chimney_has") + " " : str1 + " " + GameStrings.getString(GameStrings.actions, "base_chimney_empty");
      ...
      if (flag1 || flag2)
        str2 = str2 + " " + GameStrings.getString(GameStrings.actions, "base_chimney_has_end");
    ...
    else
    {
      ...
      else if (this.usedItem == "charcoal_empty" || this.usedItem == "pest_note" || this.usedItem == "gas_note" || this.usedItem == "spider_note" || this.usedItem == "wad_of_cash" || this.usedItem == "invoices")
      {
        ...
        else
        {
          ...
          this.updateAll();
          this.talkAndGetUp(GameStrings.getString(GameStrings.actions, "chimney_kindling1") + " " + GameStrings.getPrefixedShort(GameStrings.items, this.usedItem) + " " + GameStrings.getString(GameStrings.actions, "chimney_kindling2"));
        }
      }
      if (this.usedItem == "planks1" || this.usedItem == "planks2" || this.usedItem == "planks3" || this.usedItem == "planks4" || this.usedItem == "planks5" || this.usedItem == "charcoal")
      {
