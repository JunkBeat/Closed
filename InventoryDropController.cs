...
public class InventoryDropController : ObjectActionController
{
  ...
  private void OnMouseEnter()
  {
    ...
    if (!PlayerController.pc.allowDrop)
      ...
      gameObject.GetComponent<TextFieldController>().viewText(GameStrings.getString(GameStrings.gui, "drop1") + " " + GameStrings.getString(GameStrings.items, CursorController.cc.selectedItemName + "_short_accusative") + " " + GameStrings.getString(GameStrings.gui, "drop2"), quick: true, mwidth: 224);
  }
