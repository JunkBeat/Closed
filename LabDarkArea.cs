...
public class LabDarkArea : AreaEffect
{
  public float proc = 0.4f;

  public override void Action(WalkController wc, NPCWalkController npcwc, GroundItemController gic)
  {
    if ((Object) wc != (Object) null)
      wc.gameObject.GetComponent<SpriteRenderer>().color = new Color(this.proc, this.proc, this.proc);
    if ((Object) npcwc != (Object) null)
    {
      npcwc.colorBlue = this.proc;
      npcwc.colorRed = this.proc;
      npcwc.colorGreen = this.proc;
    ...
    if (!((Object) gic != (Object) null))
      return;
    gic.gameObject.GetComponent<SpriteRenderer>().color = new Color(this.proc, this.proc, this.proc);
  }
