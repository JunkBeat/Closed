...
public class DialogueController : MonoBehaviour
{
  ...
  public void quickDialogue(Vector3 color, NPCActionController who, string what)
  {
    ...
    DialogueController.dc.initDialogue(dialogueLines, what, PlayerController.pc.textField, new Vector3(1f, 1f, 1f), component, color);
    ...
    Sprite background = null)
  {
    ...
    List<DialogueLine> dialogueLineList = dialogueLines;
    bool flag = false;
    int num = 1;
    if (prefix == string.Empty)
    {
      dialogueLineList.Add(new DialogueLine(tf_a, color_a, string.Empty, (TimelineFunction) null));
      dialogueLineList[dialogueLineList.Count - 1].displayText = false;
    }
    else
    {
      do
      {
        ...
        if (str1.IndexOf("_STRING_MISSING") == -1)
        {
          string t = str1;
          tC = color_a;
          dialogueLineList.Add(new DialogueLine(tf_a, tC, t, (TimelineFunction) null));
        }
        else if (str2.IndexOf("_STRING_MISSING") == -1)
        {
          string t = str2;
          tC = color_b;
          dialogueLineList.Add(new DialogueLine(tf_b, tC, t, (TimelineFunction) null));
        }
        else if (str3.IndexOf("_STRING_MISSING") == -1)
        {
          string t = str3;
          tC = color_c;
          dialogueLineList.Add(new DialogueLine(tf_c, tC, t, (TimelineFunction) null));
        }
        else
          flag = true;
        ++num;
