...
public class RestaurantCupboard1 : ObjectActionController
{
  public Sprite s1;
  public Sprite s2;
  ...
  {
    if (GameDataController.gd.getObjective("restaurant_cupboard1_open"))
      return;
    PlayerController.pc.aS.PlayOneShot(SoundsManagerController.sm.cabinet_1);
    GameDataController.gd.setObjective("restaurant_cupboard1_open", true);
    this.updateState();
  }
