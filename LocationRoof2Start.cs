...
public class LocationRoof2Start : MonoBehaviour
{
  ...
  private void Start()
  {
    ...
    GameDataController.gd.setObjective("visited_roof2", true);
    ...
    if (GameDataController.gd.getObjective("base_fireplace_lit"))
    {
      ...
      GameObject.Find("Smoke2").GetComponent<ParticleGenerator>().started = true;
    }
    else if (!GameDataController.gd.getObjective("base_fireplace_lit"))
    {
      GameObject.Find("Smoke1").GetComponent<ParticleGenerator>().started = false;
      GameObject.Find("Smoke2").GetComponent<ParticleGenerator>().started = false;
    }
