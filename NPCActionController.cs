...
public class NPCActionController : ObjectActionController
{
  ...
  public void decideRandomTopic()
  {
    ...
    else if (GameDataController.gd.getCurrentDay() < 5)
    {
      ...
      string id;
      if (SceneManager.GetActiveScene().name != "LocationSiderealRoof" && (SceneManager.GetActiveScene().name != "LocationRestaurant5" || GameDataController.gd.getCurrentDay() > 2) && GameDataController.gd.getObjective("npc3_joined") && GameDataController.gd.getObjective("npc2_joined") && GameDataController.gd.getObjective("npc3_alive") && GameDataController.gd.getObjective("npc2_alive") && !GameDataController.gd.getObjective("barry_warned") && !GameDataController.gd.getObjective("cody_warned"))
      {
      ...
      else if (SceneManager.GetActiveScene().name != "LocationSiderealRoof" && (SceneManager.GetActiveScene().name != "LocationRestaurant5" || GameDataController.gd.getCurrentDay() > 2) && GameDataController.gd.getObjective("npc3_joined") && GameDataController.gd.getObjective("npc2_joined") && GameDataController.gd.getObjective("npc3_alive") && !GameDataController.gd.getObjective("npc2_alive"))
      {
        float num = Random.Range(0.0f, 1f);
      ...
      else if (SceneManager.GetActiveScene().name != "LocationSiderealRoof" && (SceneManager.GetActiveScene().name != "LocationRestaurant5" || GameDataController.gd.getCurrentDay() > 2) && GameDataController.gd.getObjective("npc3_joined") && GameDataController.gd.getObjective("npc2_joined") && !GameDataController.gd.getObjective("npc3_alive") && GameDataController.gd.getObjective("npc2_alive"))
      {
        ...
        id = !(SceneManager.GetActiveScene().name != "LocationSiderealRoof") || !(SceneManager.GetActiveScene().name != "LocationRestaurant5") && GameDataController.gd.getCurrentDay() <= 2 || !GameDataController.gd.getObjective("npc3_joined") || !GameDataController.gd.getObjective("npc3_alive") || GameDataController.gd.getObjective("cody_warned") ? (!(SceneManager.GetActiveScene().name != "LocationSiderealRoof") || !(SceneManager.GetActiveScene().name != "LocationRestaurant5") && GameDataController.gd.getCurrentDay() <= 2 || !GameDataController.gd.getObjective("npc2_joined") || !GameDataController.gd.getObjective("npc2_alive") || GameDataController.gd.getObjective("barry_warned") ? str1 + "_cate" : ((double) Random.Range(0.0f, 1f) >= 0.5 ? str1 + "_cate_barry" : str1 + "_cate")) : ((double) Random.Range(0.0f, 1f) >= 0.5 ? str1 + "_cate_cody" : str1 + "_cate");
      string str2 = GameDataController.gd.getObjectiveDetail(id).ToString().Substring(0, 1);
      MonoBehaviour.print((object) ("WYBIERAM TEMAT..... " + id + " ........... " + str2));
      if (GameDataController.gd.getObjectiveDetail(id).ToString().Length > 1)
      {
        string s = GameDataController.gd.getObjectiveDetail(id).ToString().Substring(1) + str2;
  ...
  public void randomLinesTalkOrNot(bool force = false)
  {
    if (PlayerController.wc.busy || CursorController.cc.getCurrentState() == CursorController.PixelCursor.OK)
      return;
    if (!force && (SceneManager.GetActiveScene().name == "LocationSiderealRoof" || SceneManager.GetActiveScene().name == "LocationOutpostOutside2" || PlayerController.wc.busy || GameObject.Find("Ginger").GetComponent<NPCActionController>().busyTalkingRandomly || GameObject.Find("Npc2").GetComponent<NPCActionController>().busyTalkingRandomly || GameObject.Find("Npc3").GetComponent<NPCActionController>().busyTalkingRandomly || !this.gameObject.GetComponent<NPCWalkController>().spawned))
    {
