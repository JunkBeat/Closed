...
public class ClockController : MonoBehaviour
{
  ...
  {
    string str1 = (GameDataController.gd.timeLimit - GameDataController.gd.gameTime) / 60 != 1 ? GameStrings.getString(GameStrings.gui, "left_prefix") : GameStrings.getString(GameStrings.gui, "left_prefix2");
    if (str1.Length > 0)
      str1 += " ";
  ...
  public static string getTimeLeft()
  {
    ...
    int num = GameDataController.gd.timeLimit - GameDataController.gd.gameTime;
    int inputText1 = num / 60;
    int inputText2 = num % 60;
    string[] strArray1 = new string[3]
    {
      GameStrings.getString(GameStrings.gui, "hour"),
      GameStrings.getString(GameStrings.gui, "hour2"),
      GameStrings.getString(GameStrings.gui, "hours")
    };
    string[] strArray2 = new string[3]
    {
      GameStrings.getString(GameStrings.gui, "minute"),
      GameStrings.getString(GameStrings.gui, "minute2"),
      GameStrings.getString(GameStrings.gui, "minutes")
    };
    int[] numArray = new int[6]{ 2, 0, 1, 1, 1, 2 };
    string str1 = strArray1[inputText1 % 10 <= 4 || inputText1 % 10 >= 20 ? numArray[inputText1 % 10 < 5 ? inputText1 % 10 : 5] : 2];
    string str2 = strArray2[inputText2 % 10 <= 4 || inputText2 % 10 >= 20 ? numArray[inputText2 % 10 < 5 ? inputText2 % 10 : 5] : 2];
    string str3 = ClockController.IsThisException(inputText1) ? empty + inputText1.ToString() + " " + strArray1[2] : empty + inputText1.ToString() + " " + str1;
    string str4;
    if (!ClockController.IsThisException(inputText2))
      str4 = str3 + " " + inputText2.ToString() + " " + str2;
    else
      str4 = str3 + " " + inputText2.ToString() + " " + strArray2[2];
    return str4;
  }
  ...
  private void addItem(string item, string how)
  {
    if (!InventoryController.ic.isItemInInventory(item))
      return;
    this.takeDoc(this.equip_i);
    this.doc.caption = !(how == "equip_arm") ? GameStrings.getString(GameStrings.gui, how) + " " + GameStrings.getString(GameStrings.items, item + "_short_accusative") + "." : GameStrings.getString(GameStrings.gui, how) + " " + GameStrings.getString(GameStrings.items, item + "_short_instrumental") + ".";
  ...
  public static bool IsThisException(int inputText)
  {
