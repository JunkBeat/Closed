...
public class LanguageSelectorCaption : MonoBehaviour
{
  ...
  {
    this.t.viewText(GameStrings.getString(GameStrings.languages, PlayerPrefs.GetString("lang", GameStrings.Language.PL.ToString())), quick: true, instant: true, mwidth: 200, r: 0.5f, g: 0.5f, b: 0.5f, ba: 0.0f);
