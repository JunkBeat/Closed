...
public class RV_Socket_Placed : ObjectActionController
{
  ...
  {
    if (GameDataController.gd.getObjective("rv_cord_plugged") && !GameDataController.gd.getObjective("rv_cord_caged"))
      this.setCollider(0);
    else
      this.setCollider(-1);
  }
