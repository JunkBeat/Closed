...
public class HouseBArea2 : AreaEffect
{
  public override void Action(WalkController wc, NPCWalkController npcwc, GroundItemController gic)
  {
    if ((Object) wc != (Object) null)
      wc.gameObject.GetComponent<SpriteRenderer>().color = new Color(0.1f, 0.1f, 0.1f);
    if ((Object) npcwc != (Object) null)
    {
      npcwc.colorBlue = 0.1f;
      npcwc.colorRed = 0.1f;
      npcwc.colorGreen = 0.1f;
    ...
    if (!((Object) gic != (Object) null))
      return;
    gic.gameObject.GetComponent<SpriteRenderer>().color = new Color(0.1f, 0.1f, 0.1f);
  }
