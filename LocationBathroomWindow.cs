...
public class LocationBathroomWindow : ObjectActionController
{
  ...
  {
    if (!GameDataController.gd.getObjective("base_window_3_net") && !GameDataController.gd.getObjective("base_window_3_bars") && !GameDataController.gd.getObjective("base_window_3_foil") && !GameDataController.gd.getObjective("base_window_3_therm") && !GameDataController.gd.getObjective("base_window_3_blanket") && !GameDataController.gd.getObjective("base_window_3_blanketb") && !GameDataController.gd.getObjective("base_window_3_flag") && !GameDataController.gd.getObjective("base_window_3_board"))
    {
      ...
      else
      {
        if (this.usedItem.IndexOf("window_bars") != -1)
          GameDataController.gd.setObjective("base_window_3_bars", true);
        else if (this.usedItem.IndexOf("window_net") != -1)
          GameDataController.gd.setObjective("base_window_3_net", true);
        else if (this.usedItem.IndexOf("window_foil") != -1)
          GameDataController.gd.setObjective("base_window_3_foil", true);
        else if (this.usedItem == "blanket")
          GameDataController.gd.setObjective("base_window_3_blanket", true);
        else if (this.usedItem == "blanketb")
          GameDataController.gd.setObjective("base_window_3_blanketb", true);
        else if (this.usedItem == "flag")
          GameDataController.gd.setObjective("base_window_3_flag", true);
        else if (this.usedItem == "thermalb")
          GameDataController.gd.setObjective("base_window_3_therm", true);
        else if (this.usedItem.IndexOf("board") != -1)
          GameDataController.gd.setObjective("base_window_3_board", true);
        InventoryController.ic.removeItem(this.usedItem);
        ItemsManager.im.updateItem(this.usedItem, "window3", 0, 0);
    ...
    {
      if (GameDataController.gd.getObjective("base_window_3_bars_nailed") || GameDataController.gd.getObjective("base_window_3_bars_taped") || GameDataController.gd.getObjective("base_window_3_net_nailed") || GameDataController.gd.getObjective("base_window_3_net_taped") || GameDataController.gd.getObjective("base_window_3_therm_nailed") || GameDataController.gd.getObjective("base_window_3_therm_taped") || GameDataController.gd.getObjective("base_window_3_flag_taped") || GameDataController.gd.getObjective("base_window_3_flag_nailed") || GameDataController.gd.getObjective("base_window_3_board_taped") || GameDataController.gd.getObjective("base_window_3_board_nailed") || GameDataController.gd.getObjective("base_window_3_blanket_taped") || GameDataController.gd.getObjective("base_window_3_blanketb_taped") || GameDataController.gd.getObjective("base_window_3_blanket_nailed") || GameDataController.gd.getObjective("base_window_3_blanketb_nailed") || GameDataController.gd.getObjective("base_window_3_foil_nailed") || GameDataController.gd.getObjective("base_window_3_foil_taped"))
      {
        if (GameDataController.gd.getObjective("base_window_3_bars_nailed") || GameDataController.gd.getObjective("base_window_3_foil_nailed") || GameDataController.gd.getObjective("base_window_3_therm_nailed") || GameDataController.gd.getObjective("base_window_3_flag_nailed") || GameDataController.gd.getObjective("base_window_3_board_nailed") || GameDataController.gd.getObjective("base_window_3_blanket_nailed") || GameDataController.gd.getObjective("base_window_3_blanketb_nailed") || GameDataController.gd.getObjective("base_window_3_net_nailed"))
      ...
      else
      {
        ...
        {
          if (objArray[index].dataRef.droppedLocation == "window3" && InventoryController.ic.pickUpItem(objArray[index]))
          {
            ...
            GameDataController.gd.setObjective("base_window_3_therm", false);
            GameDataController.gd.setObjective("base_window_3_flag", false);
            GameDataController.gd.setObjective("base_window_3_board", false);
            GameDataController.gd.setObjective("base_window_3_blanket", false);
            GameDataController.gd.setObjective("base_window_3_blanketb", false);
            this.updateState();
          }
        }
      }
    ...
    {
      if ((GameDataController.gd.getObjective("base_window_3_bars_nailed") || GameDataController.gd.getObjective("base_window_3_foil_nailed") || GameDataController.gd.getObjective("base_window_3_flag_nailed") || GameDataController.gd.getObjective("base_window_3_board_nailed") || GameDataController.gd.getObjective("base_window_3_therm_nailed") || GameDataController.gd.getObjective("base_window_3_blanket_nailed") || GameDataController.gd.getObjective("base_window_3_blanketb_nailed") || GameDataController.gd.getObjective("base_window_3_net_nailed")) && (this.usedItem == "hammer" || this.usedItem == "crowbar"))
      ...
      {
        if (this.usedItem == "hammer" && (GameDataController.gd.getObjective("base_window_3_bars_nailed") || GameDataController.gd.getObjective("base_window_3_net_nailed") || GameDataController.gd.getObjective("base_window_3_flag_nailed") || GameDataController.gd.getObjective("base_window_3_board_nailed") || GameDataController.gd.getObjective("base_window_3_blanket_nailed") || GameDataController.gd.getObjective("base_window_3_blanketb_nailed") || GameDataController.gd.getObjective("base_window_3_therm_nailed") || GameDataController.gd.getObjective("base_window_3_foil_nailed")))
          return;
        if (this.usedItem == "ducttape" && (GameDataController.gd.getObjective("base_window_3_bars_taped") || GameDataController.gd.getObjective("base_window_3_net_taped") || GameDataController.gd.getObjective("base_window_3_foil_taped") || GameDataController.gd.getObjective("base_window_3_board_taped") || GameDataController.gd.getObjective("base_window_3_flag_taped") || GameDataController.gd.getObjective("base_window_3_blanket_taped") || GameDataController.gd.getObjective("base_window_3_blanketb_taped") || GameDataController.gd.getObjective("base_window_3_therm_taped")))
        ...
        else if (this.usedItem == "crowbar" && !GameDataController.gd.getObjective("base_window_3_bars_nailed") && !GameDataController.gd.getObjective("base_window_3_foil_nailed") && !GameDataController.gd.getObjective("base_window_3_flag_nailed") && !GameDataController.gd.getObjective("base_window_3_board_nailed") && !GameDataController.gd.getObjective("base_window_3_blanket_nailed") && !GameDataController.gd.getObjective("base_window_3_blanketb_nailed") && !GameDataController.gd.getObjective("base_window_3_therm_nailed") && !GameDataController.gd.getObjective("base_window_3_net_nailed"))
        {
          PlayerController.pc.textField.viewText(GameStrings.getString(GameStrings.actions, "window_crowbar"), true);
        }
        else
        {
          ...
          if (GameDataController.gd.getObjective("base_window_3_bars"))
            key += "_bars";
          if (GameDataController.gd.getObjective("base_window_3_net"))
            key += "_net";
          if (GameDataController.gd.getObjective("base_window_3_foil"))
            key += "_foil";
          if (GameDataController.gd.getObjective("base_window_3_flag"))
            key += "_flag";
          if (GameDataController.gd.getObjective("base_window_3_board"))
            key += "_board";
          if (GameDataController.gd.getObjective("base_window_3_therm"))
            key += "_therm";
          if (GameDataController.gd.getObjective("base_window_3_blanket"))
            key += "_blanket";
          if (GameDataController.gd.getObjective("base_window_3_blanketb"))
            key += "_blanket";
          int time = 20;
  ...
  {
    GameDataController.gd.setObjective("base_window_3_bars_nailed", false);
    GameDataController.gd.setObjective("base_window_3_bars_taped", false);
    GameDataController.gd.setObjective("base_window_3_net_nailed", false);
    GameDataController.gd.setObjective("base_window_3_net_taped", false);
    GameDataController.gd.setObjective("base_window_3_bars_taped", false);
    GameDataController.gd.setObjective("base_window_3_board_taped", false);
    GameDataController.gd.setObjective("base_window_3_board_nailed", false);
    GameDataController.gd.setObjective("base_window_3_foil_nailed", false);
    GameDataController.gd.setObjective("base_window_3_foil_taped", false);
    GameDataController.gd.setObjective("base_window_3_flag_taped", false);
    GameDataController.gd.setObjective("base_window_3_flag_nailed", false);
    GameDataController.gd.setObjective("base_window_3_blanket_taped", false);
    GameDataController.gd.setObjective("base_window_3_blanketb_taped", false);
    GameDataController.gd.setObjective("base_window_3_blanket_nailed", false);
    GameDataController.gd.setObjective("base_window_3_blanketb_nailed", false);
    GameDataController.gd.setObjective("base_window_3_therm_taped", false);
    GameDataController.gd.setObjective("base_window_3_therm_nailed", false);
    ...
    for (int index = 0; index < objArray.Length; ++index)
    {
      if (objArray[index].dataRef.droppedLocation == "window3")
      {
        ...
        obj.dataRef.droppedLocation = "LocationBaseBathroom";
  ...
  public void removeIfBroken(bool hadNails = false)
  {
    ...
    GameDataController.gd.setObjective("base_window_3_net", false);
    GameDataController.gd.setObjective("base_window_3_foil", false);
    if (ItemsManager.im.getItem("window_bars1").dataRef.droppedLocation == "window3")
      ItemsManager.im.getItem("window_bars1").dataRef.droppedLocation = "nowhere";
    if (ItemsManager.im.getItem("window_bars2").dataRef.droppedLocation == "window3")
      ItemsManager.im.getItem("window_bars2").dataRef.droppedLocation = "nowhere";
    if (ItemsManager.im.getItem("window_bars3").dataRef.droppedLocation == "window3")
      ItemsManager.im.getItem("window_bars3").dataRef.droppedLocation = "nowhere";
    if (ItemsManager.im.getItem("window_net1").dataRef.droppedLocation == "window3")
      ItemsManager.im.getItem("window_net1").dataRef.droppedLocation = "nowhere";
    if (ItemsManager.im.getItem("window_net2").dataRef.droppedLocation == "window3")
      ItemsManager.im.getItem("window_net2").dataRef.droppedLocation = "nowhere";
    if (ItemsManager.im.getItem("window_net3").dataRef.droppedLocation == "window3")
      ItemsManager.im.getItem("window_net3").dataRef.droppedLocation = "nowhere";
    if (ItemsManager.im.getItem("window_foil1").dataRef.droppedLocation == "window3")
      ItemsManager.im.getItem("window_foil1").dataRef.droppedLocation = "nowhere";
    if (ItemsManager.im.getItem("window_foil2").dataRef.droppedLocation == "window3")
      ItemsManager.im.getItem("window_foil2").dataRef.droppedLocation = "nowhere";
    if (ItemsManager.im.getItem("window_foil3").dataRef.droppedLocation == "window3")
      ItemsManager.im.getItem("window_foil3").dataRef.droppedLocation = "nowhere";
    if (ItemsManager.im.getItem("board1").dataRef.droppedLocation == "window3")
      ItemsManager.im.getItem("board1").dataRef.droppedLocation = "nowhere";
    if (ItemsManager.im.getItem("board2").dataRef.droppedLocation == "window3")
      ItemsManager.im.getItem("board2").dataRef.droppedLocation = "nowhere";
    if (ItemsManager.im.getItem("board3").dataRef.droppedLocation == "window3")
    ...
    GameDataController.gd.setObjective("base_window3_broken", false);
  }
  ...
  public void yesTaped()
  {
    ...
    if (GameDataController.gd.getObjective("base_window_3_bars"))
      GameDataController.gd.setObjective("base_window_3_bars_taped", true);
    if (GameDataController.gd.getObjective("base_window_3_net"))
      GameDataController.gd.setObjective("base_window_3_net_taped", true);
    if (GameDataController.gd.getObjective("base_window_3_foil"))
      GameDataController.gd.setObjective("base_window_3_foil_taped", true);
    if (GameDataController.gd.getObjective("base_window_3_flag"))
      GameDataController.gd.setObjective("base_window_3_flag_taped", true);
    if (GameDataController.gd.getObjective("base_window_3_blanket"))
      GameDataController.gd.setObjective("base_window_3_blanket_taped", true);
    if (GameDataController.gd.getObjective("base_window_3_board"))
      GameDataController.gd.setObjective("base_window_3_board_taped", true);
    if (GameDataController.gd.getObjective("base_window_3_blanketb"))
      GameDataController.gd.setObjective("base_window_3_blanketb_taped", true);
    if (GameDataController.gd.getObjective("base_window_3_therm"))
      GameDataController.gd.setObjective("base_window_3_therm_taped", true);
    PlayerController.wc.dir = WalkController.Direction.N;
    CurtainController.cc.fadeOut();
  }
  ...
  public void yesNailed()
  {
    ...
    if (GameDataController.gd.getObjective("base_window_3_bars"))
      GameDataController.gd.setObjective("base_window_3_bars_nailed", true);
    if (GameDataController.gd.getObjective("base_window_3_net"))
      GameDataController.gd.setObjective("base_window_3_net_nailed", true);
    if (GameDataController.gd.getObjective("base_window_3_foil"))
      GameDataController.gd.setObjective("base_window_3_foil_nailed", true);
    if (GameDataController.gd.getObjective("base_window_3_flag"))
      GameDataController.gd.setObjective("base_window_3_flag_nailed", true);
    if (GameDataController.gd.getObjective("base_window_3_board"))
      GameDataController.gd.setObjective("base_window_3_board_nailed", true);
    if (GameDataController.gd.getObjective("base_window_3_blanket"))
      GameDataController.gd.setObjective("base_window_3_blanket_nailed", true);
    if (GameDataController.gd.getObjective("base_window_3_blanketb"))
      GameDataController.gd.setObjective("base_window_3_blanketb_nailed", true);
    if (GameDataController.gd.getObjective("base_window_3_therm"))
      GameDataController.gd.setObjective("base_window_3_therm_nailed", true);
    Item[] objArray = new Item[5]
    {
      ItemsManager.im.getItem("nails1"),
      ItemsManager.im.getItem("nails2"),
    ...
    ItemsManager.im.updateItem(obj.id, "window3", 0, 0);
    PlayerController.wc.dir = WalkController.Direction.N;
    CurtainController.cc.fadeOut();
  }
  ...
  {
    if (!GameDataController.gd.getObjective("base_window_3_net") && !GameDataController.gd.getObjective("base_window_3_bars") && !GameDataController.gd.getObjective("base_window_3_foil") && !GameDataController.gd.getObjective("base_window_3_flag") && !GameDataController.gd.getObjective("base_window_3_board") && !GameDataController.gd.getObjective("base_window_3_blanket") && !GameDataController.gd.getObjective("base_window_3_blanketb") && !GameDataController.gd.getObjective("base_window_3_therm"))
    {
    ...
    else if (GameDataController.gd.getObjective("base_window_3_board"))
    {
      if (GameDataController.gd.getObjective("base_window_3_board_nailed") && GameDataController.gd.getObjective("base_window_3_board_taped"))
      {
      ...
      else if (GameDataController.gd.getObjective("base_window_3_board_nailed"))
      {
      ...
      else if (GameDataController.gd.getObjective("base_window_3_board_taped"))
      {
  ...
  public override void whatOnClick()
  {
    ...
    if (!GameDataController.gd.getObjective("base_window_3_bars") && !GameDataController.gd.getObjective("base_window_3_net") && !GameDataController.gd.getObjective("base_window_3_foil") && (this.usedItem.IndexOf("window_bars") != -1 || this.usedItem.IndexOf("window_foil") != -1 || this.usedItem.IndexOf("window_net") != -1 || this.usedItem.IndexOf("board") != -1 || this.usedItem == "blanket" || this.usedItem == "blanketb" || this.usedItem == "thermalb" || this.usedItem == "flag") || this.usedItem == string.Empty && (GameDataController.gd.getObjective("base_window_3_bars") || GameDataController.gd.getObjective("base_window_3_net") || GameDataController.gd.getObjective("base_window_3_foil") || GameDataController.gd.getObjective("base_window_3_flag") || GameDataController.gd.getObjective("base_window_3_blanket") || GameDataController.gd.getObjective("base_window_3_blanketb") || GameDataController.gd.getObjective("base_window_3_board") || GameDataController.gd.getObjective("base_window_3_therm")))
    {
      ...
      else if (GameDataController.gd.getObjective("base_window_3_bars_nailed") || GameDataController.gd.getObjective("base_window_3_bars_taped") || GameDataController.gd.getObjective("base_window_3_net_nailed") || GameDataController.gd.getObjective("base_window_3_net_taped") || GameDataController.gd.getObjective("base_window_3_therm_nailed") || GameDataController.gd.getObjective("base_window_3_therm_taped") || GameDataController.gd.getObjective("base_window_3_foil_nailed") || GameDataController.gd.getObjective("base_window_3_foil_taped") || GameDataController.gd.getObjective("base_window_3_board_nailed") || GameDataController.gd.getObjective("base_window_3_board_taped") || GameDataController.gd.getObjective("base_window_3_blanketb_nailed") || GameDataController.gd.getObjective("base_window_3_blanket_nailed") || GameDataController.gd.getObjective("base_window_3_blanketb_taped") || GameDataController.gd.getObjective("base_window_3_blanket_taped") || GameDataController.gd.getObjective("base_window_3_foil_nailed") || GameDataController.gd.getObjective("base_window_3_foil_taped"))
      {
        this.characterAnimationName = "action_stnd_n";
        this.animationFlip = false;
        this.doubleClickCondition = string.Empty;
