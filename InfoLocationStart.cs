...
public class InfoLocationStart : MonoBehaviour
{
  private void Start()
  {
    ...
    GameObject.Find("Location").GetComponent<LocationManager>().esc = (ObjectActionController) GameObject.Find("InfoExit").GetComponent<InfoExit>();
  }
