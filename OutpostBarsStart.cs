...
public class OutpostBarsStart : MonoBehaviour
{
  private void Start()
  {
    ...
    GameObject.Find("Location").GetComponent<LocationManager>().esc = (ObjectActionController) GameObject.Find("OutpostBarsExit").GetComponent<OutpostBarsExit>();
