...
public class PesttruckChem1 : ObjectActionController
{
  private void Start()
  {
    ...
    this.objectName = "pesttruck_chem_1";
    this.updateState();
  ...
  {
    if (this.usedItem == "chem_glass" || this.usedItem == "chem_glass_2" || this.usedItem == "chem_glass_3")
    {
      InventoryController.ic.removeItem(this.usedItem);
      if (this.usedItem == "chem_glass")
        InventoryController.ic.pickOrDropItem(ItemsManager.im.getItem("chem_glass_1"));
