...
public class GasstationAreaAction1 : AreaEffect
{
  public override void Action(WalkController wc, NPCWalkController npcwc, GroundItemController gic)
  {
    if ((Object) wc != (Object) null)
      wc.gameObject.GetComponent<SpriteRenderer>().color = new Color(0.5f, 0.5f, 0.5f);
    if ((Object) npcwc != (Object) null)
    {
      npcwc.colorBlue = 0.5f;
      npcwc.colorRed = 0.5f;
      npcwc.colorGreen = 0.5f;
    ...
    if (!((Object) gic != (Object) null))
      return;
    gic.gameObject.GetComponent<SpriteRenderer>().color = new Color(0.5f, 0.5f, 0.5f);
  }
