...
public class WaypointHouseB1 : ObjectActionController
{
  private void Start()
  {
    ...
    this.objectName = "house_b_waypoint1";
  ...
  public override void clickAction()
  {
    ...
    {
      PlayerController.pc.spawnName = "WaypointHouseBBack0";
      CurtainController.cc.fadeOut("LocationHouseBBack", WalkController.Direction.E);
    }
  }
