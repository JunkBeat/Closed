...
public class RestaurantSolider2 : ObjectActionController
{
  public GameObject sarge;
  protected DialogueOptionController doc;
  public TextFieldController textField;
  public static Vector3 color = new Vector3(0.6196079f, 0.7529412f, 0.8666667f);
  ...
  private void Start()
  {
    ...
    this.objectName = "restaurant_solider_2";
    this.range = 30f;
    ...
    this.position2 = new Vector2(128f, 50f);
  ...
  public void initIntroDialogue()
  {
    ...
    DialogueController.dc.initDialogue(dialogueLines, "r_mark_intro1", PlayerController.pc.textField, new Vector3(1f, 1f, 1f), this.sarge.GetComponent<TextFieldController>(), RestaurantSolider2.color, GameObject.Find("Ginger").GetComponent<TextFieldController>(), GingerActionController.getColor());
  ...
  public void dialogues()
  {
    ...
    int i1 = 0;
    this.takeDoc(i1);
    this.doc.caption = GameStrings.getString(GameStrings.dialogues, "r_mark_sarge1_caption");
    ...
    this.doc.setObjective("r_mark_sarge1");
    DialogueController.dc.initDialogue(this.doc.lines, "r_mark_sarge1", PlayerController.pc.textField, new Vector3(1f, 1f, 1f), GameObject.Find("Ginger").GetComponent<TextFieldController>(), GingerActionController.getColor(), this.textField, RestaurantSolider2.color);
    int i2 = i1 + 1;
    this.takeDoc(i2);
    this.doc.caption = GameStrings.getString(GameStrings.dialogues, "r_mark_come1_caption");
    this.doc.gameObject.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>("Bitmaps/Dialogues/sarge_ship");
    this.doc.lines = new List<DialogueLine>();
    this.doc.setObjective("r_mark_come1");
    DialogueController.dc.initDialogue(this.doc.lines, "r_mark_come1", PlayerController.pc.textField, new Vector3(1f, 1f, 1f), GameObject.Find("Ginger").GetComponent<TextFieldController>(), GingerActionController.getColor(), this.textField, RestaurantSolider2.color);
    int i3 = i2 + 1;
    this.takeDoc(i3);
    ...
    this.doc.lines = new List<DialogueLine>();
    this.doc.setObjective("r_mark_bye1");
    DialogueController.dc.initDialogue(this.doc.lines, "r_mark_bye1", PlayerController.pc.textField, new Vector3(1f, 1f, 1f), this.textField, RestaurantSolider2.color);
  ...
  private void Update()
  {
    ...
    this.shadow.update(this.position, new Vector2(this.position2.x, 30f), 0);
  }
  ...
  public override void updateState()
  {
    ...
    else
    {
      ...
      if (GameDataController.gd.getObjective("restaurant_sarge_encountered"))
        this.sarge.GetComponent<Animator>().Play("solider2_guard_loop");
      else
        this.sarge.GetComponent<Animator>().Play("solider2_aim_start");
    }
  }
