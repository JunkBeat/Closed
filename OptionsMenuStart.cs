...
public class OptionsMenuStart : MonoBehaviour
{
  ...
  private void Start()
  {
    ...
    Button component9 = GameObject.Find("FontBtn").GetComponent<Button>();
    if (PlayerPrefs.GetString("font", "pixel") == "pixel")
      component9.initButton("[" + GameStrings.getString(GameStrings.gui, "font") + ": " + GameStrings.getString(GameStrings.gui, "font_pixel") + "]");
    else
      component9.initButton("[" + GameStrings.getString(GameStrings.gui, "font") + ": " + GameStrings.getString(GameStrings.gui, "font_smooth") + "]");
    component9.workIfBusy = false;
    component9.onClick = new Button.Delegate(this.pickFont);
    Button component10 = GameObject.Find("LanguageBtn").GetComponent<Button>();
    component10.initButton("[" + GameStrings.getString(GameStrings.gui, "language") + ": " + GameStrings.getString(GameStrings.languages, PlayerPrefs.GetString("lang")) + "]");
    component10.workIfBusy = false;
    component10.onClick = new Button.Delegate(this.pickLanguage);
    TextFieldController component11 = GameObject.Find("Caption_Speed").GetComponent<TextFieldController>();
    component11.viewText(GameStrings.getString(GameStrings.gui, "text_speed") + ":", quick: true, instant: true, mwidth: 100, ba: 0.0f);
    ...
    TextFieldController component12 = GameObject.Find("Caption_Static").GetComponent<TextFieldController>();
    component12.viewText(GameStrings.getString(GameStrings.gui, "static") + ":", quick: true, instant: true, mwidth: 100, ba: 0.0f);
    component12.keepAlive = true;
    component12.transform.position = ScreenControler.roundToNearestFullPixel2(component12.transform.position);
    TextFieldController component13 = GameObject.Find("Caption_Music").GetComponent<TextFieldController>();
    component13.viewText(GameStrings.getString(GameStrings.gui, "music") + ":", quick: true, instant: true, mwidth: 100, ba: 0.0f);
    component13.keepAlive = true;
    component13.transform.position = ScreenControler.roundToNearestFullPixel2(component12.transform.position);
    TextFieldController component14 = GameObject.Find("Caption_Sound").GetComponent<TextFieldController>();
    component14.viewText(GameStrings.getString(GameStrings.gui, "sound") + ":", quick: true, instant: true, mwidth: 100, ba: 0.0f);
    component14.keepAlive = true;
    component14.transform.position = ScreenControler.roundToNearestFullPixel2(component12.transform.position);
    this.counter1 = GameObject.Find("Counter1").GetComponent<TextFieldController>();
    this.counter1.transform.position = ScreenControler.roundToNearestFullPixel2(component12.transform.position);
    this.counter2 = GameObject.Find("Counter2").GetComponent<TextFieldController>();
    this.counter2.transform.position = ScreenControler.roundToNearestFullPixel2(component12.transform.position);
    this.counter3 = GameObject.Find("Counter3").GetComponent<TextFieldController>();
    this.counter3.transform.position = ScreenControler.roundToNearestFullPixel2(component12.transform.position);
    this.counter4 = GameObject.Find("Counter4").GetComponent<TextFieldController>();
    this.counter4.transform.position = ScreenControler.roundToNearestFullPixel2(component12.transform.position);
    Button component15 = GameObject.Find("SpeedBtnDown").GetComponent<Button>();
    component15.initButton("[" + GameStrings.getString(GameStrings.gui, "down") + "]");
    component15.onClick = new Button.Delegate(this.speedDown);
    component15.workIfBusy = false;
    Button component16 = GameObject.Find("SpeedBtnUp").GetComponent<Button>();
    component16.initButton("[" + GameStrings.getString(GameStrings.gui, "up") + "]");
    component16.onClick = new Button.Delegate(this.speedUp);
    component16.workIfBusy = false;
    Button component17 = GameObject.Find("StaticBtnDown").GetComponent<Button>();
    component17.initButton("[" + GameStrings.getString(GameStrings.gui, "down") + "]");
    component17.onClick = new Button.Delegate(this.staticDown);
    component17.workIfBusy = false;
    Button component18 = GameObject.Find("StaticBtnUp").GetComponent<Button>();
    component18.initButton("[" + GameStrings.getString(GameStrings.gui, "up") + "]");
    component18.onClick = new Button.Delegate(this.staticUp);
    component18.workIfBusy = false;
    Button component19 = GameObject.Find("MusicBtnDown").GetComponent<Button>();
    component19.initButton("[" + GameStrings.getString(GameStrings.gui, "down") + "]");
    component19.onClick = new Button.Delegate(this.musicDown);
    component19.workIfBusy = false;
    Button component20 = GameObject.Find("SoundBtnUp").GetComponent<Button>();
    component20.initButton("[" + GameStrings.getString(GameStrings.gui, "up") + "]");
    component20.onClick = new Button.Delegate(this.soundsUp);
    component20.workIfBusy = false;
    Button component21 = GameObject.Find("SoundBtnDown").GetComponent<Button>();
    component21.initButton("[" + GameStrings.getString(GameStrings.gui, "down") + "]");
    component21.onClick = new Button.Delegate(this.soundsDown);
    component21.workIfBusy = false;
    Button component22 = GameObject.Find("MusicBtnUp").GetComponent<Button>();
    component22.initButton("[" + GameStrings.getString(GameStrings.gui, "up") + "]");
    component22.onClick = new Button.Delegate(this.musicUp);
    ...
    int num1 = 0;
    Button component23 = GameObject.Find("ResolutionBtn").GetComponent<Button>();
    if (PlayerPrefs.GetInt("fullscreen") == 1)
    {
      component23.initButton("[" + GameStrings.getString(GameStrings.gui, "resolution") + ": " + GameStrings.getString(GameStrings.gui, "fullscreen") + "]");
    }
    else
    {
      ...
      component23.initButton("[" + GameStrings.getString(GameStrings.gui, "resolution") + ": " + (object) num2 + "x" + (object) num1 + "]");
    }
    component23.workIfBusy = false;
    component23.onClick = new Button.Delegate(this.pickResolution);
    if (GameDataController.persistentData.chapter1_gas || GameDataController.persistentData.chapter1_locust || GameDataController.persistentData.chapter1_spiders)
    {
      ...
      component24.initButton("[" + GameStrings.getString(GameStrings.gui, "clear_data") + "]");
      component24.workIfBusy = false;
      component24.onClick = new Button.Delegate(this.clearData);
      component24.buttonText.OPTIONAL_MARGIN = 6;
    }
    else
    {
      Button component25 = GameObject.Find("ResetBtn").GetComponent<Button>();
      component25.initButton(" ");
      component25.workIfBusy = false;
      component25.buttonEnabled = false;
    }
